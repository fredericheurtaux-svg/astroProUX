    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-8 md:pb-6">
        <div className="max-w-4xl mb-12">
          <p className="text-2xl text-blue-600 mb-6 italic font-medium">Designer la complexité</p>
        ...
        <div className="bg-gray-50 rounded-sm p-8 md:p-12">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-sm p-8 shadow-sm min-h-96 flex items-center justify-center">
              <a href="/case-studies/OPIPRO.svg" target="_blank" rel="noopener noreferrer" className="w-full h-full flex items-center justify-center">
                <ImageWithFallback
